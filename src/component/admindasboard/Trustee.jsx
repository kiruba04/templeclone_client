...
const Volunteerview = () => {
    ...
    const handleEdit = () => {
        if (userDetails) {
            navigate('/addtrustee', { state: { userDetails } });
        }
    };
    ...
    const handleDownload = async () => {
        try {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'Trustee');
            ...
            link.href = url;
            link.setAttribute('download', 'Trustee.xlsx');
    ...
    return (
        <div>
            <h2 className='heading'>Search Trustee</h2>
            <Form>
                ...
                <Button variant="link" onClick={handleRegisterNewDevotee}>Register New Trustee</Button>
            </Form>
            {error && (
                <Row className="mt-3">
                    <Col>
            ...
            {userDetails && (
                <Card.Body className='carddisplay'>
                    <Card.Title className='text-center p-3 line'>Trustee Details</Card.Title>
            ...
            <div className="mt-3">
                <Button variant="outline-success" onClick={handleDownload}>Download All Trustee</Button>
            </div>
        </div>
    );
};

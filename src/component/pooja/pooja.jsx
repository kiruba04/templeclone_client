    ...
    return(
        ...
        <div className='container containerbanner'>
            <div className='row'>
                ...
                <h5 className='headcontent1'>{t('poojahead1')}</h5>
                ...
                <div className='col-12'>
                <h5 className='headcontent1'>{t('poojahead2')}</h5>
                <div className='line2'></div>
                <p className='para2'>
                {t('poojapara2')}
                <br></br>
                ...
                <div className='col-12'>
                    <h5 className='headcontent1'>{t('poojahead3')}</h5>
                    <div className='line2'></div>
                    <p className='para3'>
                    {t('poojapara4')}
                   </p>
                ...
                <div className='col-12'>
                    <h5 className='headcontent1'>{t('poojahead4')}</h5>
                    <div className='line2'></div>
                    <p className='para6'>
                    {t('poojapara7')}
                    </p>
